...
<head>
    ...
    <title>My Travel Companion - Profile</title>
    ...
    <link rel="stylesheet" href="../Bootstrap/css/userStyle.css">    
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="page-heading">
                        <h1>About Me</h1>
                        <hr class="small">
                        <span class="subheading"><a href="#"><font color="white">Edit my Profile</font></a></span>
                    </div>
                </div>
            </div>
        </div>
